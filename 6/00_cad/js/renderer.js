window.Renderer = function(canvasId){
  ...
  this._modelMatrixLoc = undefined;
  this._viewProjMatrixLoc = undefined;
  this._colorLoc = undefined;
}
...
Renderer.prototype.render = function(instance){
...
Renderer.prototype._loadModelMatrix = function(matrix){
